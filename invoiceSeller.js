...
function TaxInvoiceSeller({ invoiceData }) {
  ...
  // Get images from invoiceData or fallback to default imports
  // For now, always use the imported images since they're available
  const companySealImage = img_lp;
  const signatureImage = sign_lp;
  
  console.log('Company Seal Image:', companySealImage);
  console.log('Signature Image:', signatureImage);
  console.log('Invoice Data Products:', invoiceData.products);
      ...
      <div style={styles.invoiceContainer}>
        <table style={styles.table}>
          <tbody>
            {/* Header */}
            <tr>
              <td colSpan="9" style={{...styles.td, ...styles.header}}>TAX INVOICE</td>
            </tr>
            
            {/* Company Information */}
            <tr>
              <td colSpan="6" style={{...styles.td, ...styles.sectionHeader, ...styles.left}}>{invoiceData.company.name}</td>
              <td colSpan="3" style={{...styles.td, ...styles.sectionHeader, ...styles.left}}>GSTIN : {invoiceData.company.gstin}</td>
            </tr>
            <tr>
              <td colSpan="6" style={{...styles.td, ...styles.sectionHeader, ...styles.left}}>{invoiceData.company.address}</td>
              <td colSpan="3" style={{...styles.td, ...styles.sectionHeader, ...styles.left}}>PAN : {invoiceData.company.pan}</td>
            </tr>
            <tr>
              <td colSpan="5" style={{...styles.td, ...styles.left}}>Contact / Email : {invoiceData.company.contact} / {invoiceData.company.email}</td>
            ...
            {/* Spacer */}
            <tr>
              <td colSpan="9" style={{...styles.td, ...styles.spacerRow}}></td>
            </tr>
            ...
            <tr>
              ...
              <td colSpan="5" style={{...styles.td, ...styles.bold, ...styles.left}}>GSTIN : {invoiceData.shipTo.gstin}</td>
            </tr>
        ...
        <table style={{...styles.table, ...styles.productTable}}>
          <tbody>
            ...
            {invoiceData.products.map((product, index) => {
              // Calculate amount WITHOUT IGST: (rate × quantity) - discount
              const baseAmount = (parseFloat(product.rate) * parseInt(product.quantity)) - parseFloat(product.discount || 0);
              const displayAmount = product.amount || baseAmount.toFixed(2);
              
              console.log(`Product ${index + 1} amount (without IGST):`, displayAmount);
              return (
                <tr key={index} style={styles.productRow}>
                  ...
                  <td style={{...styles.td, ...styles.productCell, ...styles.colAmount}}>₹{displayAmount}</td>
                </tr>
              );
            })}
            ...
            <tr>
              ...
              <td style={{...styles.td, ...styles.right, ...styles.totalRow}}></td>
              <td style={{...styles.td, ...styles.right, ...styles.totalRow}}></td>
              <td style={{...styles.td, ...styles.right, ...styles.totalRow}}>₹{invoiceData.totals.taxableAmount}</td>
            </tr>
          </tbody>
        </table>
        ...
        <table style={styles.table}>
          <tbody>
            ...
            <tr style={styles.amountSection}>
              <td colSpan="5" style={{...styles.td, ...styles.center}}>Total Amount In Words</td>
            ...
            <tr style={styles.amountSection}>
              <td colSpan="5" style={{...styles.td, ...styles.left}}>{invoiceData.totals.amountInWords}</td>
              <td colSpan="2" style={{...styles.td, ...styles.right}}>IGST :</td>
              <td colSpan="2" style={{...styles.td, ...styles.right}}>₹{invoiceData.totals.igst}</td>
            </tr>
            <tr style={styles.amountSection}>
              <td colSpan="5" style={{...styles.td, ...styles.center}}>Bank Details</td>
            ...
            <tr style={styles.amountSection}>
              <td colSpan="5" style={{...styles.td, ...styles.left}}>A/C Name : {invoiceData.bankDetails.accountName}</td>
            ...
            <tr style={styles.amountSection}>
              ...
              <td colSpan="5" style={{...styles.td, ...styles.left}}>IFSC Code: {invoiceData.bankDetails.ifscCode}</td>
            </tr>
            
            {/* Declarations */}
            <tr>
              <td colSpan="5" style={{...styles.td, ...styles.declarationSection, ...styles.left, height: '80px', verticalAlign: 'top', padding: '12px'}}>
              ...
              <td colSpan="2" style={{...styles.td, ...styles.center, verticalAlign: 'middle'}}>
                <img 
                  src={companySealImage}
                  alt="Company Seal" 
                  style={{maxWidth: '120px', maxHeight: '80px', display: 'block', margin: '0 auto'}}
                  onError={(e) => {
                    console.log('Seal image failed to load:', companySealImage);
                  }}
                />
                <br/>
              ...
              <td colSpan="2" style={{...styles.td, ...styles.center, verticalAlign: 'middle'}}>
                ...
                <img 
                  ...
                  style={{maxWidth: '120px', maxHeight: '80px', display: 'block', margin: '0 auto'}}
                  onError={(e) => {
                    console.log('Signature image failed to load:', signatureImage);
                  }}
                />
                <br/>
